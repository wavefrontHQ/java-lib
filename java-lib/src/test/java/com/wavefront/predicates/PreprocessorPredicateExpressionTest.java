...
public class PreprocessorPredicateExpressionTest {
  ...
  public void testMath() {
    ...
    assertEq(1, parseEvalExpression("1 = 1 and 0 = 0").getValue(null));
    assertEq(1, parseEvalExpression("1 = 2 and 0 = 0 or 2 = 2 ").getValue(null));
    assertEq(1, parseEvalExpression("1 = 2 or 0 = 0 and 2 = 2 ").getValue(null));
    assertEq(1, parseEvalExpression("0 and 1 or 1 ").getValue(null));
    assertEq(1, parseEvalExpression("0 or 1 and 1 ").getValue(null));
    assertEq(0, parseEvalExpression("0 and 1 or 0 ").getValue(null));
    assertEq(1, parseEvalExpression("1 and not 0").getValue(null));
    assertEq(0, parseEvalExpression("1 and not 1").getValue(null));
    assertEq(1, parseEvalExpression("1 and not 0 or 0").getValue(null));
    assertEq(1, parseEvalExpression("1 and not 1 or 1").getValue(null));
  ...
  public void testStringComparison() {
    ...
    assertEq(1, parseEvalExpression("'abcde' matches 'a*e'").getValue(null));
    assertEq(1, parseEvalExpression("'abcde' matches '*cde'").getValue(null));
    assertEq(1, parseEvalExpression("'abcde' matches 'ab*'").getValue(null));
    assertEq(1, parseEvalExpression("'abcde' matches '*bc*'").getValue(null));
    assertEq(1, parseEvalExpression("'abcde' matches '*'").getValue(null));
    assertEq(0, parseEvalExpression("'abcde' matches '*dc*'").getValue(null));
    assertEq(0, parseEvalExpression("'abcde' matches '*z*'").getValue(null));
    assertEq(1, parseEvalExpression("'abCDe' matchesIgnoreCase 'a*E'").getValue(null));
    assertEq(1, parseEvalExpression("'abCDe' matchesIgnoreCase '*cDe'").getValue(null));
    assertEq(1, parseEvalExpression("'abCDe' matchesIgnoreCase 'Ab*'").getValue(null));
    assertEq(1, parseEvalExpression("'abCDe' matchesIgnoreCase '*bC*'").getValue(null));
    assertEq(1, parseEvalExpression("'abCDe' matchesIgnoreCase '*'").getValue(null));
    assertEq(0, parseEvalExpression("'abCDe' matchesIgnoreCase '*DC*'").getValue(null));
  ...
  @Test
  public void testIff() {
    assertEq(4, parseEvalExpression("(2 = 2) ? 5 : 6 - 1").getValue(null));
    assertEq(7, parseEvalExpression("(2 != 2) ? 5 : 6 + 1").getValue(null));
  ...
  public void testSpanExpression() {
    ...
    assertEq(1, parseEvalExpression("{{foo}} all matches '*ar*'").getValue(span));
    assertEq(1, parseEvalExpression("{{foo}} any matches '*az'").getValue(span));
    assertEq(0, parseEvalExpression("{{foo}} any matches '*q*'").getValue(span));
